...
const FLOORS = [
  {
    ...
    rooms: [
      ...
      { id: 'trapp1', name: 'Trapp',
        x: 4.3, y: 9.5, w: 0.7, h: 2.0,
        color: '#e4e0da' },
      { id: 'tekrom', name: 'Tek.Rom 2m²',
        x: 4.3, y: 11.5, w: 0.7, h: 2.9,
        color: '#e0dbd2' },
      { id: 'kjokken', name: 'Kjøkken 8m²',
        x: 0, y: 12.0, w: 2.0, h: 4.0,
        color: '#e8f0ed' },
      { id: 'entre', name: 'Entré 4,5m²',
        x: 2.0, y: 12.0, w: 1.5, h: 3.0,
        color: '#ede8f0' },
      { id: 'terrasse_bak', name: 'Terrasse 4m²',
        x: 2.0, y: 15.0, w: 2.0, h: 2.0,
        color: '#e8e0d0', dashed: true },
      { id: 'bod1', name: 'Bod 5m²',
        x: 2.0, y: 17.0, w: 2.0, h: 2.5,
        color: '#e0dbd2' },
    ],
  },

  {
    ...
    rooms: [
      // Venstre kolonne: soverom 1 (2,8m bred) over bad (2,8m bred)
      ...
      { id: 'bad', name: 'Bad 7,5m²',
        ...
        color: '#d6eaf8' },
      // Høyre kolonne: soverom 2 (2,2m bred) over gang/trapp (2,2m bred)
      { id: 'sov2', name: 'Soverom 7m²',
        x: 2.8, y: 0, w: 2.2, h: 3.2,
        color: '#e8edf0' },
      { id: 'gang2', name: 'Gang M/trapp 8,5m²',
        x: 2.8, y: 3.2, w: 2.2, h: 3.9,
        color: '#f0ede8' },
      // Soverom 3: hele bredden nederst
...

  {
    ...
    rooms: [
      { id: 'takter', name: 'Takterrasse 17m²',
        x: 0, y: 0, w: 5.0, h: 3.4,
        color: '#e8e0d0', dashed: true },
      // Stue: venstre del (bredde ~4,1m, bod+trapp på høyre ~0,7+0,2m vegg)
      { id: 'stue3', name: 'Stue 15,5m²',
        x: 0, y: 3.4, w: 4.1, h: 3.8,
        color: '#f0ede8' },
      // Bod: smal og stående (0,7 × 1,4m)
      { id: 'bod3', name: 'Bod 1m²',
        x: 4.1, y: 3.4, w: 0.7, h: 1.4,
        color: '#e0dbd2' },
      // Trapp: samme bredde som bod (0,7m)
      { id: 'trapp3', name: 'Trapp',
        x: 4.1, y: 4.8, w: 0.7, h: 2.4,
        color: '#e4e0da' },
      // Soverom: nesten kvadratisk (2,8 × 2,9m)
      { id: 'sov4', name: 'Soverom 8m²',
        x: 0, y: 7.2, w: 2.8, h: 2.9,
        color: '#e8edf0' },
      // Vaskerom: nesten kvadratisk, litt bredere enn dypt (2,2 × 2,0m)
      { id: 'vask', name: 'Vaskerom 4,5m²',
        x: 2.8, y: 7.2, w: 2.2, h: 2.0,
        color: '#d6eaf8' },
    ],
  },
];
